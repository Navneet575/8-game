...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        ...
        for(int i = 0 ; i < tiles.length ; ++i){
            ...
            tiles[i].setFont(new java.awt.Font("Segoe UI", 0, 20));
            //tiles[i].setForeground(java.awt.Color.blue);
        ...
        Button_Restart.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //if(GUI.this.boardControl.isSolving()) return;
                GUI.this.boardControl.reseted = true;
                GUI.this.boardControl.randomizeBoard();
                GUI.this.drawBoard();
                GUI.this.setStatus("");
            }
        ...
        //action listener for the solve button
         ...
         Button_Solve_ASTAR.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(GUI.this.boardControl.isSolving()) return;
                GUI.this.boardControl.reseted = false;
                GUI.this.boardControl.solve(GUI.this, Solvers.SOLVE_METHOD.ASTAR);
                GUI.this.pack();
        ...
        Button_Solve_BFS.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(GUI.this.boardControl.isSolving()) return;
                GUI.this.boardControl.reseted = false;
                GUI.this.boardControl.solve(GUI.this, Solvers.SOLVE_METHOD.BFS);
                GUI.this.pack();
                //GUI.this.setLocationRelativeTo(null);
            }
        });
    ...
    private void initComponents() {
        ...
        Button_Solve_ASTAR = new javax.swing.JButton();
       ...
       // Button_Speed = new javax.swing.JButton();
        ...
        ButtonsPanel.add(Button_Restart, gridBagConstraints);

        Button_Solve_ASTAR.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        Button_Solve_ASTAR.setText("Solve A*");
        Button_Solve_ASTAR.setFocusable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ButtonsPanel.add(Button_Solve_ASTAR, gridBagConstraints);

        Button_Solve_BFS.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        ...
        Button_Solve_DFS.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
...
//        ButtonsPanel.add(Button_Speed, gridBagConstraints);
        ...
        Tile_2.setText("2");
        //Tile_2.setBackground(Color.yellow);
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        Tile_3.setText("3");
        //Tile_3.setBackground(Color.red);
        //Tile_3.setForeground(Color.yellow);
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    private javax.swing.JButton Button_Solve_ASTAR;
